...
class WeekTest extends TestCase
{
    ...
    public static function weekNavigationDataProvider(): array
    {
        return [
            ...
            'EG 2021-W52' => ['ar-EG', 52, 2021, 53, 2021, 51, 2021],
            'EG 2021-W53' => ['ar-EG', 53, 2021, 1, 2022, 52, 2021],
            'EG 2022-W1' => ['ar-EG', 1, 2022, 2, 2022, 53, 2021],
            'EG 2026-W52' => ['ar-EG', 52, 2026, 1, 2027, 51, 2026],
            'EG 2027-W1' => ['ar-EG', 1, 2027, 2, 2027, 52, 2026],
            'EG 2027-W52' => ['ar-EG', 52, 2027, 53, 2027, 51, 2027],
            'EG 2027-W53' => ['ar-EG', 53, 2027, 1, 2028, 52, 2027],
            'EG 2028-W1' => ['ar-EG', 1, 2028, 2, 2028, 53, 2027],
    ...
    public static function formatDataProvider(): array
    {
        return [
            ...
            'DE W1 2026' => ['de-DE', 1, 2026, '1', '01', '01 2026'],
            'DE W53 2026' => ['de-DE', 53, 2026, '53', '53', '53 2026'],
            'EG W1 2019' => ['ar-EG', 1, 2019, '١', '٠١', '٠١ ٢٠١٩'],
            'EG W53 2021' => ['ar-EG', 53, 2021, '٥٣', '٥٣', '٥٣ ٢٠٢١'],
            'EG W53 2027' => ['ar-EG', 53, 2027, '٥٣', '٥٣', '٥٣ ٢٠٢٧'],
    ...
    public static function nameFormatDataProvider(): array
    {
        return [
            ...
            'EG W53 2021' => ['ar-EG', 53, 2021, '٥٣', '٥٣', '٥٣'],
            'EG W53 2027' => ['ar-EG', 53, 2027, '٥٣', '٥٣', '٥٣'],
